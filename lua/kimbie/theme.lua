...
local colors = require("kimbie.colors")
...
function M.setup(config)
  ...
  theme.base = {
    ...
    -- FIXME: I want blue statusbar!!!
    StatusLine = { fg = c.fg_sidebar, bg = c.bg_statusline },                      -- status line of current window
    StatusLineNC = { fg = c.fg_gutter, bg = c.bg2 },                               -- status lines of not-current windows Note: if this is equal to "StatusLine" Vim will use "^^^" in the status line of the current window.
    TabLine = { bg = c.bg2, fg = c.fg_gutter },                                    -- tab pages line, not active tab page label
    ...
    ["@conditional.ternary"] = { fg = c.fg },
    ["@string.scss"] = { fg = c.purple },
    ["@label"] = { fg = c.red },
  ...
  theme.plugins = {
    ...
    TSPunctDelimiter = { fg = c.green }, -- For delimiters ie: `.`
    TSPunctBracket = { fg = c.green },   -- For brackets and parens.
  ...
  if config.hideInactiveStatusline then
    ...
    if vim.o.statusline ~= nil and string.find(vim.o.statusline, "lualine") then
      ...
      -- https://github.com/ful1e5/kimbie.nvim/issues/2
      -- https://github.com/hoob3rt/lualine.nvim/issues/274
      theme.base.StatusLine = { bg = c.bg_statusline }
